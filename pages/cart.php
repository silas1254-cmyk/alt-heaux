                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group input-group-sm" style="width: 100px;">
                                                    ...
                                                    <button type="button" class="btn btn-outline-secondary" data-action="qty-decrease" data-product-id="<?php echo $item['product_id']; ?>" data-color="<?php echo htmlspecialchars($item['selected_color'] ?? ''); ?>" data-size="<?php echo htmlspecialchars($item['selected_size'] ?? ''); ?>">−</button>
                                                    ...
                                                    <button type="button" class="btn btn-outline-secondary" data-action="qty-increase" data-product-id="<?php echo $item['product_id']; ?>" data-color="<?php echo htmlspecialchars($item['selected_color'] ?? ''); ?>" data-size="<?php echo htmlspecialchars($item['selected_size'] ?? ''); ?>">+</button>
                                                </div>
                                            </td>
                                            <!-- LINE TOTAL COLUMN -->
