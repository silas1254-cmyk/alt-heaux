                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <a href="<?php echo SITE_URL; ?>admin/products.php" class="btn btn-dark btn-sm d-block mb-2">
                                    <i class="bi bi-plus"></i> Add New Product
                                </a>
                                <a href="<?php echo SITE_URL; ?>admin/products.php" class="btn btn-outline-dark btn-sm d-block mb-2">
                                    <i class="bi bi-box"></i> Manage Products
                                </a>
                                <a href="<?php echo SITE_URL; ?>admin/categories.php" class="btn btn-outline-dark btn-sm d-block">
                    ...
                    <div class="col-md-6">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <a href="<?php echo SITE_URL; ?>admin/settings.php" class="btn btn-outline-dark btn-sm d-block mb-2">
                                    <i class="bi bi-gear"></i> Site Settings
                                </a>
                                <a href="<?php echo SITE_URL; ?>admin/menus.php" class="btn btn-outline-dark btn-sm d-block mb-2">
                                    <i class="bi bi-list"></i> Navigation Menu
                                </a>
                                <a href="<?php echo SITE_URL; ?>admin/sliders.php" class="btn btn-outline-dark btn-sm d-block mb-2">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <a href="<?php echo SITE_URL; ?>admin/sales_dashboard.php" class="btn btn-outline-dark btn-sm d-block">
                    ...
                    <div class="col-md-6">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <?php if (isAdmin()): ?>
                                    <a href="<?php echo SITE_URL; ?>admin/manage_admins.php" class="btn btn-outline-dark btn-sm d-block mb-2">
                                        <i class="bi bi-people"></i> Manage Admin Users
                                    </a>
                                    <a href="<?php echo SITE_URL; ?>admin/updates.php" class="btn btn-outline-dark btn-sm d-block">
                        ...
                        <div class="card-body">
                            ...
                            <?php else: ?>
                                ...
                                <div class="text-center mt-3">
                                    <a href="<?php echo SITE_URL; ?>admin/updates.php" class="btn btn-sm btn-outline-dark">
                                        View Full Audit Log →
                                    </a>
                                </div>
                            <?php endif; ?>
